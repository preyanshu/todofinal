import { ADD_TASK, DELETE_TASK, TOGGLE_TASK_DONE } from '../actions/taskActionTypes';
const initialState = {
...
const taskReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case TOGGLE_TASK_DONE:
            const updatedTasksToggle = state.tasks.map((task) => task.id === action.payload ? { ...task, isDone: !task.isDone } : task);
